...
export function LandingPage() {
    return (
        <div className="min-h-screen bg-white text-slate-900 selection:bg-[var(--color-primary)] selection:text-white">
            {/* 1. Header Navigation */}
            ...
            <span className="relative text-[var(--color-primary)] font-semibold cursor-pointer">
              Home
              <span className="absolute -bottom-5 left-0 right-0 h-0.5 bg-[var(--color-primary)] rounded-full" />
            </span>
                    ...
                    <div className="flex items-center gap-4">
                        <Link
                            to="/login"
                            className="text-sm font-semibold text-slate-700 hover:text-[var(--color-primary)] transition-colors px-2 py-1"
                        >
                            Login
                        </Link>
                        <Link to="/register">
            ...
            <main className="relative overflow-hidden pt-12 pb-24 lg:pt-20 lg:pb-32">
                ...
                <div className="pointer-events-none absolute -top-24 left-1/2 -translate-x-1/2 w-[1000px] h-[450px] bg-gradient-to-b from-red-50/50 via-rose-50/20 to-transparent rounded-full blur-3xl -z-10" />
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-8">
                        ...
                        <div className="space-y-8 lg:col-span-6 xl:col-span-5">
                            {/* Badge */}
                            <div className="inline-flex items-center gap-2 rounded-full bg-red-50/80 px-3.5 py-1.5 text-xs font-semibold text-[var(--color-primary)] border border-red-100/60">
                            ...
                            >
                                Transform Your Future<span className="text-[var(--color-primary)]">.</span>
                            </h1>
                        ...
                        <div className="relative lg:col-span-6 xl:col-span-7 flex justify-center lg:justify-end">
                            <div className="relative w-full max-w-xl">
                                ...
                                <div className="absolute -bottom-6 -left-2 sm:-bottom-8 sm:-left-6 bg-white/95 backdrop-blur-md rounded-2xl p-4 shadow-xl shadow-slate-900/10 border border-slate-100 flex items-center gap-3.5 select-none">
                                    <div className="w-11 h-11 rounded-xl bg-[var(--color-primary)] text-white flex items-center justify-center shadow-md shadow-red-950/20">
