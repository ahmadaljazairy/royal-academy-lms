...
export function LandingPage() {
    ...
    return (
        <div className="min-h-screen bg-white text-slate-900 selection:bg-primary selection:text-white">
            ...
            <header className="sticky top-0 z-50 w-full border-b border-slate-100 bg-white/90 backdrop-blur-md">
                <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
                    ...
                    <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
                        <a
                            href="#home"
                            className="relative text-primary font-semibold transition-colors"
                        >
                            Home
                    ...
                    <div className="flex items-center gap-3 sm:gap-4 min-h-9">
                        {isLoading ? (
                            // Subtle skeleton placeholder to eliminate Cumulative Layout Shift (CLS)
                            ...
                            <div className="flex items-center gap-3">
                                <Link to="/dashboard">
                                    <Button
                                        size="sm"
                                        className="rounded-full px-5 shadow-sm shadow-red-950/10 hover:shadow-md transition-all"
                                    >
                                        Dashboard →
                                    </Button>
                                </Link>
                            ...
                            <>
                                ...
                                <Link to="/register">
                                    <Button
                                        size="sm"
                                        className="rounded-full px-5 shadow-sm shadow-red-950/10"
                                    >
                                        Register
                                    </Button>
                                </Link>
            ...
            {/* 2. Hero Section                                              */}
            {/* ============================================================ */}
            <main id="home" className="relative overflow-hidden pt-12 pb-24 lg:pt-20 lg:pb-32">
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-8">
                        ...
                        <div className="space-y-8 lg:col-span-6 xl:col-span-5">
                            {/* Badge */}
                            <div className="inline-flex items-center gap-2 rounded-full bg-red-50/80 px-3.5 py-1.5 text-xs font-semibold text-primary border border-red-100/60 shadow-xs">
                            ...
                            <p className="text-base sm:text-lg text-slate-600 leading-relaxed max-w-lg">
                                Empowering professionals with international certifications and
                                industry-leading training programs designed for the global market.
                            </p>
                            ...
                            <div className="flex flex-wrap items-center gap-3 sm:gap-4 pt-1">
                                {isAuthenticated ? (
                                    <Link to="/dashboard">
                                        <Button className="rounded-full px-6 py-3 shadow-lg shadow-red-950/15">
                            ...
                            <div className="pt-8 border-t border-slate-100 grid grid-cols-3 gap-6 sm:gap-8">
                                <div>
